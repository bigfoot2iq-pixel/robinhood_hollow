    ...
    <header className="sticky top-0 z-10 bg-dark-navy/80 backdrop-blur-md border-b border-white/10 px-4 lg:px-8 py-4 flex items-center justify-between">
      <div className="flex items-center gap-3 lg:gap-6 flex-1 min-w-0">
        ...
        <div className="hidden xl:flex gap-4">
          <a className="text-sm text-muted-blue hover:text-[#F4FF1A] transition-colors" href="#">Explorer</a>
          <a className="text-sm text-muted-blue hover:text-[#F4FF1A] transition-colors" href="#">Marketplace</a>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 lg:gap-4">
        {isConnected && balance !== undefined && (
          <div className="px-2 lg:px-4 py-2 bg-white/5 border border-white/10 rounded-full flex items-center gap-2">
            <div className="w-2 h-2 rounded-full bg-[#F4FF1A] animate-pulse"></div>
        ...
        <div className="relative group hidden xl:block">
          ...
          <input
            className="bg-white/10 border-none rounded pl-10 pr-4 py-2 text-sm focus:ring-1 focus:ring-[#F4FF1A] w-64 text-white placeholder-muted-blue"
            placeholder="Search..."
            type="text"
          />
        </div>

        <button className="p-2 bg-white/10 rounded text-white hover:bg-[#F4FF1A] hover:text-dark-navy transition-all">
