    ...
    <div className="space-y-6 lg:space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
        ...
        <div className="ui-container rounded overflow-hidden flex flex-col">
          <div className="p-6 lg:p-8 border-b border-white/5 flex flex-col flex-1">
            <div className="flex items-center gap-3 lg:gap-4 mb-4 lg:mb-6">
              <div className="w-12 h-12 lg:w-14 lg:h-14 bg-[#F4FF1A] flex items-center justify-center rounded-xl flex-shrink-0">
        ...
        <div className="ui-container rounded overflow-hidden flex flex-col">
          <div className="p-6 lg:p-8 border-b border-white/5 flex flex-col flex-1">
            <div className="flex items-center gap-3 lg:gap-4 mb-4 lg:mb-6">
              <div className="w-12 h-12 lg:w-14 lg:h-14 bg-[#F4FF1A] flex items-center justify-center rounded-xl flex-shrink-0">
                <span className="material-symbols-outlined text-dark-navy" style={{ fontSize: 28 }}>token</span>
              </div>
              <div>
                <h3 className="text-xl lg:text-2xl font-header text-white">Stake Tokens</h3>
                <p className="text-muted-blue text-xs lg:text-sm">Earn rewards by staking your tokens</p>
              </div>
            </div>
            <p className="text-muted-blue text-xs lg:text-sm leading-relaxed mb-4 lg:mb-6 flex-1">
              Stake your HOLLOW tokens to earn passive rewards and participate in platform governance.
            </p>
            <Link href="/staking">
              <button className="w-full py-3 lg:py-4 bg-white/5 hover:bg-white/10 text-white font-bold rounded uppercase tracking-[0.15em] text-xs lg:text-sm transition-all border border-white/10">
                Start Staking
      ...
      <div className="ui-container rounded p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          <div className="flex flex-col items-center text-center">
            <div className="w-12 h-12 rounded-full bg-[#F4FF1A] flex items-center justify-center text-dark-navy font-bold text-lg mb-4">
              1
            </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
        <div className="ui-container rounded p-5 lg:p-6">
          <div className="w-10 h-10 rounded bg-[#F4FF1A]/20 flex items-center justify-center mb-4">
            <span className="material-symbols-outlined text-[#F4FF1A]">shield</span>
          </div>
        ...
        <div className="ui-container rounded p-5 lg:p-6">
          <div className="w-10 h-10 rounded bg-[#F4FF1A]/20 flex items-center justify-center mb-4">
            <span className="material-symbols-outlined text-[#F4FF1A]">trophy</span>
          </div>
        ...
        <div className="ui-container rounded p-5 lg:p-6 sm:col-span-2 lg:col-span-1">
          <div className="w-10 h-10 rounded bg-[#F4FF1A]/20 flex items-center justify-center mb-4">
            <span className="material-symbols-outlined text-[#F4FF1A]">bolt</span>
          </div>
